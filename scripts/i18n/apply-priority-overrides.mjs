...
const MESSAGE_OVERRIDES = {
  es: {
    ...
    "auth.stopServer": "Detén el servidor GalyarderRoute",
  ...
  ja: {
    ...
    "auth.stopServer": "GalyarderRoute サーバーを停止",
...
const README_NAV_OVERRIDES = {
  "README.ja.md":
    "[🌐 ウェブサイト](https://galyarder-route.online) • [🚀 クイックスタート](#-クイックスタート) • [💡 主な機能](#-主な機能) • [📖 ドキュメント](#-ドキュメント) • [💰 料金](#-価格の概要) • [💬 WhatsApp](https://chat.whatsapp.com/JI7cDQ1GyaiDHhVBpLxf8b?mode=gi_t)",
  "README.ar.md":
    "[🌐 الموقع](https://galyarder-route.online) • [🚀 البداية السريعة](#-بداية-سريعة) • [💡 الميزات](#-الميزات-الرئيسية) • [📖 التوثيق](#-التوثيق) • [💰 الأسعار](#-لمحة-سريعة-عن-الأسعار) • [💬 WhatsApp](https://chat.whatsapp.com/JI7cDQ1GyaiDHhVBpLxf8b?mode=gi_t)",
};
...
function removeEnglishPortugueseAnchorLine(content) {
  ...
  const filtered = lines.filter(
    (line) =>
      !line.includes(
        "**[English](#-galyarder-route--the-free-ai-gateway)** | **[Português (BR)](#-galyarder-route--gateway-de-ia-gratuito)**"
      )
  );
