...
const explicitBaseUrl = process.env.GALYARDER_ROUTE_BASE_URL || "";
  ...
  const testEnv = {
    ...
    ...(explicitBaseUrl
      ...
      : {
          ...
          GALYARDER_ROUTE_BASE_URL: baseUrl,
        }),
    GALYARDER_ROUTE_E2E_BOOTSTRAP_MODE: process.env.GALYARDER_ROUTE_E2E_BOOTSTRAP_MODE || "open",
  };
