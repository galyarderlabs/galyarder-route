...
viable_data = {
    ...
    1764: {
        ...
        "solves": "Galyarder Route fails to start or install properly on Termux because `wreq-js` attempts to load a native `libgcc` arm64 module which is incompatible.",
        ...
        "req_summary": "Detect termux environments during installation or runtime and gracefully handle the `wreq-js` native module failure, allowing the rest of Galyarder Route to function.",
...
| --- | ---------------- | ----- | ------------ | -------- | ------------ |
| 1   | Galyarder Route Source | -     | 2026-05-01   | Internal | High         |
