/**
 * MCP Tool Schemas — Contracts for all 22 core and advanced GalyarderRoute MCP tools.
 *
 ...
 *
 * Each tool wraps existing GalyarderRoute API endpoints and exposes them through
...
export interface McpToolDefinition<TInput extends z.ZodTypeAny, TOutput extends z.ZodTypeAny> {
  ...
  phase: 1 | 2;
  /** Source endpoints on GalyarderRoute that this tool wraps */
  sourceEndpoints: readonly string[];
}

// ============ Phase 1: Essential Tools (8) ============

// --- Tool 1: galyarder_route_get_health ---
...
export const getHealthTool: McpToolDefinition<typeof getHealthInput, typeof getHealthOutput> = {
  name: "galyarder_route_get_health",
  description:
    "Returns the current health status of GalyarderRoute including uptime, memory usage, circuit breaker states for all providers, rate limit status, and cache statistics.",
...
// --- Tool 2: galyarder_route_list_combos ---
...
export const listCombosTool: McpToolDefinition<typeof listCombosInput, typeof listCombosOutput> = {
  name: "galyarder_route_list_combos",
  description:
...
// --- Tool 3: galyarder_route_get_combo_metrics ---
...
> = {
  name: "galyarder_route_get_combo_metrics",
  description:
...
// --- Tool 4: galyarder_route_switch_combo ---
...
export const switchComboTool: McpToolDefinition<typeof switchComboInput, typeof switchComboOutput> =
  {
    name: "galyarder_route_switch_combo",
    description:
...
// --- Tool 5: galyarder_route_check_quota ---
...
// --- Tool 6: galyarder_route_route_request ---
...
> = {
  ...
  description:
    "Sends a chat completion request through GalyarderRoute's intelligent routing pipeline. Supports combo selection, budget limits, and task role hints for optimal provider matching.",
...
// --- Tool 7: galyarder_route_cost_report ---
...
// --- Tool 8: galyarder_route_list_models_catalog ---
...
> = {
  name: "galyarder_route_list_models_catalog",
  description:
...
// --- Tool 9: galyarder_route_web_search ---
...
export const webSearchTool: McpToolDefinition<typeof webSearchInput, typeof webSearchOutput> = {
  name: "galyarder_route_web_search",
  description:
    "Performs a web search using GalyarderRoute's search gateway. Supports multiple providers (Serper, Brave, Perplexity, Exa, Tavily, Google PSE, Linkup, SearchAPI, SearXNG) with automatic failover. Returns search results with titles, URLs, snippets, and position data.",
...
// --- Tool 9: galyarder_route_simulate_route ---
...
// --- Tool 10: galyarder_route_set_budget_guard ---
...
> = {
  name: "galyarder_route_set_budget_guard",
  description:
...
// --- Tool 11: galyarder_route_set_routing_strategy ---
...
> = {
  name: "galyarder_route_set_routing_strategy",
  description:
...
// --- Tool 12: galyarder_route_set_resilience_profile ---
...
> = {
  name: "galyarder_route_set_resilience_profile",
  description:
...
// --- Tool 13: galyarder_route_test_combo ---
...
export const testComboTool: McpToolDefinition<typeof testComboInput, typeof testComboOutput> = {
  name: "galyarder_route_test_combo",
  description:
...
// --- Tool 14: galyarder_route_get_provider_metrics ---
...
> = {
  name: "galyarder_route_get_provider_metrics",
  description:
...
// --- Tool 15: galyarder_route_best_combo_for_task ---
...
> = {
  name: "galyarder_route_best_combo_for_task",
  description:
...
// --- Tool 16: galyarder_route_explain_route ---
...
// --- Tool 17: galyarder_route_get_session_snapshot ---
...
> = {
  name: "galyarder_route_get_session_snapshot",
  description:
...
// --- Tool 18: galyarder_route_db_health_check ---
...
> = {
  name: "galyarder_route_db_health_check",
  description:
    "Diagnoses GalyarderRoute database drift such as orphan quota/domain rows, invalid JSON state, and broken combo references. Set autoRepair=true to repair those rows before returning the report.",
...
// --- Tool 19: galyarder_route_sync_pricing ---
...
export const syncPricingTool: McpToolDefinition<typeof syncPricingInput, typeof syncPricingOutput> =
  {
    name: "galyarder_route_sync_pricing",
    description:
      "Syncs pricing data from external sources (LiteLLM) into GalyarderRoute. Synced pricing fills gaps not covered by hardcoded defaults without overwriting user-set prices. Use dryRun=true to preview.",
...
export const cacheStatsTool: McpToolDefinition<typeof cacheStatsInput, typeof cacheStatsOutput> = {
  name: "galyarder_route_cache_stats",
  description:
...
export const cacheFlushTool: McpToolDefinition<typeof cacheFlushInput, typeof cacheFlushOutput> = {
  name: "galyarder_route_cache_flush",
  description:
...
> = {
  name: "galyarder_route_compression_status",
  description:
...
> = {
  name: "galyarder_route_compression_configure",
  description:
...
> = {
  name: "galyarder_route_set_compression_engine",
...
> = {
  name: "galyarder_route_list_compression_combos",
...
> = {
  name: "galyarder_route_compression_combo_stats",
...
> = {
  name: "galyarder_route_oneproxy_fetch",
  description:
...
> = {
  name: "galyarder_route_oneproxy_rotate",
  description:
...
> = {
  name: "galyarder_route_oneproxy_stats",
  description:
