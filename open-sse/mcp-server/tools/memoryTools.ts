...
export const memoryTools = {
  galyarder_route_memory_search: {
    name: "galyarder_route_memory_search",
  ...
  galyarder_route_memory_add: {
    name: "galyarder_route_memory_add",
  ...
  galyarder_route_memory_clear: {
    name: "galyarder_route_memory_clear",
