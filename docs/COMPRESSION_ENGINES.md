...
Galyarder Route compression is built around engine contracts. A mode can run one engine directly
...
with a `22-87%` range, and a `~46%` input-compression tool. Galyarder Route uses the Caveman input-side
...
| Tool                                | Scope               | Purpose                          |
| ----------------------------------- | ------------------- | -------------------------------- |
| `galyarder_route_compression_status`      | `read:compression`  | Settings, analytics, cache stats |
| `galyarder_route_compression_configure`   | `write:compression` | Update global settings           |
| `galyarder_route_set_compression_engine`  | `write:compression` | Set mode and optional pipeline   |
| `galyarder_route_list_compression_combos` | `read:compression`  | List compression combos          |
| `galyarder_route_compression_combo_stats` | `read:compression`  | Read combo/engine analytics      |
