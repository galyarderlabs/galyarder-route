...
> Consolidated from 6 community repositories. Use with Galyarder Route to route through 25+ free providers simultaneously.
...
- [Using with Galyarder Route](#using-with-galyarder-route)
- [Glossary](#glossary)
...
## Using with Galyarder Route

Galyarder Route supports **all providers listed above** as connections. Here's how to maximize free usage:
...
```bash
# These providers work out of the box with Galyarder Route:
