...
Este guia documenta o padrão ouro de infraestrutura de rede para proteger o **Galyarder Route** e expor sua aplicação de forma segura para a internet, **sem abrir nenhuma porta (Zero Inbound)**.

## O que foi feito na sua VM?

Nós ativamos o Galyarder Route em modo **Split-Port** através do PM2:
...
3. Clique em **Add a Tunnel**, escolha **Cloudflared** e dê o nome \`Galyarder Route-VM\`.
...
- **Subdomain:** \`galyarder-route\` ou \`painel\`
...
3. Em **Application name**, coloque \`Painel Galyarder Route\`.
4. Em **Application domain**, coloque \`galyarder-route.seuglobal.com.br\` (O mesmo que você fez na "Rota 2").
5. Clique em **Next**.
...
4. **Name:** \`Anti-Abuso Galyarder Route API\`
...
2. O Galyarder Route só conversa HTTPS saindo (\`cloudflared\`) e não recebendo TCP direto do mundo.
