...
If you discover a security vulnerability in Galyarder Route, please report it responsibly:

1. **DO NOT** open a public GitHub issue
2. Use [GitHub Security Advisories](https://github.com/galyarderlabs/galyarder-route/security/advisories/new)
...
Galyarder Route implements a multi-layered security model:
