# 🚀 Galyarder Route — The Free AI Gateway (Português (Portugal))
...
[![npm version](https://img.shields.io/npm/v/galyarder-route?color=cb3837&logo=npm)](https://www.npmjs.com/package/galyarder-route)
[![Docker Hub](https://img.shields.io/docker/v/galyarderlabs/galyarder-route?label=Docker%20Hub&logo=docker&color=2496ED)](https://hub.docker.com/r/galyarderlabs/galyarder-route)

![NPM Downloads](https://img.shields.io/npm/dw/galyarder-route?label=npm%20down%20week&color=red)
![NPM Downloads](https://img.shields.io/npm/dm/galyarder-route?label=npm%20down%20month&color=red)

![NPM Downloads](https://img.shields.io/npm/d18m/galyarder-route?label=npm%20down%20year&color=red)
![Docker Pulls](https://img.shields.io/docker/pulls/galyarderlabs/galyarder-route)
![GitHub Downloads (all assets, all releases)](https://img.shields.io/github/downloads/galyarderlabs/galyarder-route/total?style=flat&label=eletron%20donwloads&color=blue)

[![stars](https://custom-icon-badges.demolab.com/github/stars/galyarderlabs/galyarder-route?logo=star&style=flat)](https://github.com/galyarderlabs/galyarder-route/stargazers)
[![open issues](https://custom-icon-badges.demolab.com/github/issues-raw/galyarderlabs/galyarder-route?logo=issue)](https://github.com/galyarderlabs/galyarder-route/issues)
[![license](https://custom-icon-badges.demolab.com/github/license/galyarderlabs/galyarder-route?logo=law)](https://github.com/galyarderlabs/galyarder-route/blob/main/LICENSE)
[![last commit](https://custom-icon-badges.demolab.com/github/last-commit/galyarderlabs/galyarder-route?logo=history&logoColor=white)](https://github.com/galyarderlabs/galyarder-route/commits/main)
[![total contributions](https://custom-icon-badges.demolab.com/badge/dynamic/json?logo=graph&logoColor=fff&color=blue&label=total%20contributions&query=%24.totalContributions&url=https%3A%2F%2Fstreak-stats.demolab.com%2F%3Fuser%3Dgalyarderlabs%26type%3Djson)](https://github.com/galyarderlabs)
[![code size](https://custom-icon-badges.demolab.com/github/languages/code-size/galyarderlabs/galyarder-route?logo=file-code&logoColor=white)](https://github.com/galyarderlabs/galyarder-route)
[![pr closed](https://custom-icon-badges.demolab.com/github/issues-pr-closed/galyarderlabs/galyarder-route?color=purple&logo=git-pull-request&logoColor=white)](https://github.com/galyarderlabs/galyarder-route/pulls?q=is%3Apr+is%3Aclosed)
[![tag](https://custom-icon-badges.demolab.com/github/v/tag/galyarderlabs/galyarder-route?logo=tag&logoColor=white)](https://github.com/galyarderlabs/galyarder-route/tags)
[![github streak](https://custom-icon-badges.demolab.com/badge/dynamic/json?logo=fire&logoColor=fff&color=orange&label=github%20streak&query=%24.currentStreak.length&suffix=%20days&url=https%3A%2F%2Fstreak-stats.demolab.com%2F%3Fuser%3Dgalyarderlabs%26type%3Djson)](https://github.com/galyarderlabs)
[![followers](https://custom-icon-badges.demolab.com/github/followers/galyarderlabs?logo=person-add)](https://github.com/galyarderlabs?tab=followers)
[![fork](https://custom-icon-badges.demolab.com/github/forks/galyarderlabs/galyarder-route?logo=fork)](https://github.com/galyarderlabs/galyarder-route/network/members)
[![watch](https://custom-icon-badges.demolab.com/github/watchers/galyarderlabs/galyarder-route?logo=eye)](https://github.com/galyarderlabs/galyarder-route/watchers)

[![License](https://img.shields.io/github/license/galyarderlabs/galyarder-route)](https://github.com/galyarderlabs/galyarder-route/blob/main/LICENSE)
[![Website](https://img.shields.io/badge/Website-galyarder-route.online-blue?logo=google-chrome&logoColor=white)](https://galyarder-route.online)
[![WhatsApp](https://img.shields.io/badge/WhatsApp-Community-25D366?logo=whatsapp&logoColor=white)](https://chat.whatsapp.com/JI7cDQ1GyaiDHhVBpLxf8b?mode=gi_t)

[🌐 Website](https://galyarder-route.online) • [🚀 Quick Start](#-quick-start) • [💡 Features](#-key-features) • [📖 Docs](#-documentation) • [💰 Pricing](#-pricing-at-a-glance) • [💬 WhatsApp](https://chat.whatsapp.com/JI7cDQ1GyaiDHhVBpLxf8b?mode=gi_t)
...
<div align="center">
  <img src="./docs/screenshots/MainGalyarder Route.png" alt="Galyarder Route Dashboard" width="800"/>
</div>
...
_Connect any AI-powered IDE or CLI tool through Galyarder Route — free API gateway for unlimited coding._
...
<sub>📡 All agents connect via <code>http://localhost:20128/v1</code> or <code>http://cloud.galyarder-route.online/v1</code> — one config, unlimited models and quota</sub>
...
- **Website**: [galyarder-route.online](https://galyarder-route.online)
- **GitHub**: [github.com/galyarderlabs/galyarder-route](https://github.com/galyarderlabs/galyarder-route)
- **Issues**: [github.com/galyarderlabs/galyarder-route/issues](https://github.com/galyarderlabs/galyarder-route/issues)
...
This generates a `system-info.txt` with your Node.js version, Galyarder Route version, OS details, installed CLI tools (qoder, gemini, claude, codex, antigravity, droid, etc.), Docker/PM2 status, and system packages — everything we need to reproduce your issue quickly. Attach the file directly to your GitHub issue.
...
## 🎯 What Galyarder Route Solves — 30 Real Pain Points & Use Cases

> **Every developer using AI tools faces these problems daily.** Galyarder Route was built to solve them all — from cost overruns to regional blocks, from broken OAuth flows to protocol operations and enterprise observability.
...
- **System Info Report** — `npm run system-info` generates `system-info.txt` with your full environment (Node version, Galyarder Route version, OS, CLI tools, Docker/PM2 status). Attach it when reporting issues for instant triage.
...
- **npm global install** — `npm install -g galyarder-route && galyarder-route` — done
...
- Built-in quick-start for `galyarder-route --mcp` and client onboarding
...
```txt
1) Start MCP transport (`galyarder-route --mcp`) for tool-driven operations
...
>
> ```bash
> pnpm install -g galyarder-route
...
Arch Linux users can install the [AUR package](https://aur.archlinux.org/packages/galyarder-route-bin), which installs Galyarder Route and provides a systemd user service:

```bash
yay -S galyarder-route-bin
systemctl --user enable --now galyarder-route.service
```

| Command                 | Description                                                 |
| ----------------------- | ----------------------------------------------------------- |
| `galyarder-route`             | Start server (`PORT=20128`, API and dashboard on same port) |
| `galyarder-route --port 3000` | Set canonical/API port to 3000                              |
| `galyarder-route --mcp`       | Start MCP server (stdio transport)                          |
| `galyarder-route --no-open`   | Don't auto-open browser                                     |
| `galyarder-route --help`      | Show help                                                   |

Optional split-port mode:

```bash
PORT=20128 DASHBOARD_PORT=20129 galyarder-route
...
When you no longer need Galyarder Route, we provide two quick scripts for a clean removal:

| Command                  | Action                                                                              |
| ------------------------ | ----------------------------------------------------------------------------------- |
| `npm run uninstall`      | Removes the system app but **keeps your DB and configurations** in `~/.galyarder-route`.  |
| `npm run uninstall:full` | Removes the app AND permanently **erases all configurations, keys, and databases**. |

> Note: To run these commands, navigate to the Galyarder Route project folder (if you cloned it) and run them. Alternatively, if globally installed, you can simply run `npm uninstall -g galyarder-route`.
...
| `STREAM_IDLE_TIMEOUT_MS` | inherits `REQUEST_TIMEOUT_MS` | Maximum gap between streaming chunks before Galyarder Route aborts the SSE stream                                                                  |

Backward compatibility is preserved: existing `FETCH_TIMEOUT_MS`, `API_BRIDGE_PROXY_TIMEOUT_MS`, and other per-layer timeout vars still work and override the shared baseline.

For Claude Code-compatible upstreams (`anthropic-compatible-cc-*`), Galyarder Route also derives the outbound `X-Stainless-Timeout` header from the resolved fetch timeout so provider-side read timeouts stay aligned with your env configuration.

For third-party Claude Code-compatible reverse proxies, Galyarder Route keeps the default
...
`cache_control`, Galyarder Route does not inject bridge-owned markers.
...
For streaming requests, `FETCH_TIMEOUT_MS` only covers connection setup / waiting for the first upstream response. Once the stream is active, Galyarder Route will only abort on an actual stall (`STREAM_IDLE_TIMEOUT_MS`) or Undici body inactivity (`FETCH_BODY_TIMEOUT_MS`).

If you run Galyarder Route behind Nginx, Caddy, Cloudflare, or another reverse proxy, make sure the proxy
timeouts are also higher than your Galyarder Route stream/fetch timeouts.
...
### 3) Point your coding tool to Galyarder Route
...
- `galyarder_route_get_health`
- `galyarder_route_list_combos`
...
For Void Linux users, you can build a native package using `xbps-src`. Save this block as `srcpkgs/galyarder-route/template`:

```bash
# Template file for 'galyarder-route'
pkgname=galyarder-route
version=3.4.1
revision=1
...
license="MIT"
homepage="https://github.com/galyarderlabs/galyarder-route"
distfiles="https://github.com/galyarderlabs/galyarder-route/archive/refs/tags/v${version}.tar.gz"
checksum=009400afee90a9f32599d8fe734145cfd84098140b7287990183dde45ae2245b
system_accounts="_galyarder-route"
galyarder_route_homedir="/var/lib/galyarder-route"
...
do_install() {
	vmkdir usr/lib/galyarder-route/.next

	vcopy .next/standalone/. usr/lib/galyarder-route/.next/standalone
	...
	for _d in \
		...
		touch "${DESTDIR}/usr/lib/galyarder-route/${_d}/.keep"
	done

	cat > "${WRKDIR}/galyarder-route" <<'EOF'
#!/bin/sh
export PORT="${PORT:-20128}"
export DATA_DIR="${DATA_DIR:-${XDG_DATA_HOME:-${HOME}/.local/share}/galyarder-route}"
export APP_LOG_TO_FILE="${APP_LOG_TO_FILE:-false}"
mkdir -p "${DATA_DIR}"
exec node /usr/lib/galyarder-route/.next/standalone/server.js "$@"
EOF
	vbin "${WRKDIR}/galyarder-route"
}
...
Galyarder Route is available as a public Docker image on [Docker Hub](https://hub.docker.com/r/galyarderlabs/galyarder-route).

**Quick run:**

```bash
docker run -d \
  --name galyarder-route \
  --restart unless-stopped \
  --stop-timeout 40 \
  -p 20128:20128 \
  -v galyarder-route-data:/app/data \
  galyarderlabs/galyarder-route:latest
```
...
- Quick Tunnels are not auto-restored after an Galyarder Route or container restart. Re-enable them from the dashboard when needed.
- Managed install currently supports Linux, macOS, and Windows on `x64` / `arm64`.
- Managed Quick Tunnels default to HTTP/2 transport to avoid noisy QUIC UDP buffer warnings in constrained container environments. Set `CLOUDFLARED_PROTOCOL=quic` or `auto` if you want a different transport.
- Docker images bundle system CA roots and pass them to managed `cloudflared`, which avoids TLS trust failures when the tunnel bootstraps inside the container.
- SQLite runs in WAL mode. `docker stop` should be allowed to finish so Galyarder Route can checkpoint the latest changes back into `storage.sqlite`.
...
- Set `CLOUDFLARED_BIN=/absolute/path/to/cloudflared` if you want Galyarder Route to use an existing binary instead of downloading one.

**Using Docker Compose with Caddy (HTTPS Auto-TLS):**

Galyarder Route can be securely exposed using Caddy's automatic SSL provisioning. Ensure your domain's DNS A record points to your server's IP.

```yaml
services:
  galyarder-route:
    image: galyarderlabs/galyarder-route:latest
    container_name: galyarder-route
    restart: unless-stopped
    volumes:
      - galyarder-route-data:/app/data
    environment:
      - PORT=20128
  ...
  caddy:
    ...
    ports:
      - "80:80"
      - "443:443"
    command: caddy reverse-proxy --from https://your-domain.com --to http://galyarder-route:20128

volumes:
  galyarder-route-data:
```

| Image                    | Tag      | Size   | Description           |
| ------------------------ | -------- | ------ | --------------------- |
| `galyarderlabs/galyarder-route` | `latest` | ~250MB | Latest stable release |
| `galyarderlabs/galyarder-route` | `3.6.2`  | ~250MB | Current version       |

---

## 🖥️ Desktop App — Offline & Always-On

> 🆕 **NEW!** Galyarder Route is now available as a **native desktop application** for Windows, macOS, and Linux.

Run Galyarder Route as a standalone desktop app — no terminal, no browser, no internet required for local models. The Electron-based app includes:

- 🖥️ **Native Window** — Dedicated app window with system tray integration
- 🔄 **Auto-Start** — Launch Galyarder Route on system login
...
When minimized, Galyarder Route lives in your system tray with quick actions:
...
**Zero cost. Never stops coding.** Configure this as one Galyarder Route combo and all fallbacks happen automatically — no manual switching ever.
...
> All models below are **100% free with zero credit card required**. Galyarder Route auto-routes between them when one quota runs out — combine them all for an unbreakable $0 combo.
...
Galyarder Route v3.6 is built as an operational platform, not just a relay proxy.
...
| 🧭 **Consolidated Endpoints Page**    | Tabbed management page with Route Gateway, MCP, A2A, and API Endpoints tabs                                                           |
...
When quota, rate, or health fails, Galyarder Route automatically moves to the next candidate without manual switching.
...
Galyarder Route includes a built-in evaluation framework to test LLM response quality against a golden set. Access it via **Analytics → Evals** in the dashboard.

### Built-in Golden Set

The pre-loaded "Galyarder Route Golden Set" contains test cases for:
...
2. Run `galyarder_route_get_health`.
3. Run `galyarder_route_list_combos`.
...
**Pro Tip:** Use Opus for complex tasks, Sonnet for speed. Galyarder Route tracks quota per model!
...
- Rotation behavior: Galyarder Route routes to the next eligible Codex account automatically.
...
**Pro Tip:** OpenAI-compatible API — works seamlessly with Galyarder Route's format translation!
...
Settings → Models → Advanced:
  ...
  OpenAI API Key: [from Galyarder Route dashboard]
...
export OPENAI_API_KEY="your-galyarder-route-api-key"
...
> **Note:** OpenClaw only works with local Galyarder Route. Use `127.0.0.1` instead of `localhost` to avoid IPv6 resolution issues.
...
Settings → API Configuration:
  ...
  Base URL: http://localhost:20128/v1
  API Key: [from Galyarder Route dashboard]
  Model: if/kimi-k2-thinking
```

### OpenCode

**Step 1:** Add Galyarder Route as a custom provider:

```bash
opencode
/connect
# Select "Other" → Enter ID: "galyarder-route" → Enter your Galyarder Route API key
```
...
```bash
/models
# Select any Galyarder Route model from the list
```

> **Tip:** Add any model available in your Galyarder Route `/v1/models` endpoint to the `models` section. Use the format `provider/model-id` from your Galyarder Route dashboard.
...
- Auto-refreshed by Galyarder Route
...
- Galyarder Route v1.0.6+ includes fallback validation via chat completions
...
> **⚠️ Important for users running Galyarder Route on a VPS, Docker, or any remote server**
...
The OAuth credentials bundled in Galyarder Route are registered **for `localhost` only**. When you access Galyarder Route on a remote server (e.g. `https://galyarder-route.myserver.com`), Google rejects the authentication with:
...
- Name: anything you like (e.g. `Galyarder Route Remote`)
...
```bash
# For Antigravity:
ANTIGRAVITY_OAUTH_CLIENT_ID=<google-oauth-client-id>
ANTIGRAVITY_OAUTH_CLIENT_SECRET=<google-oauth-client-secret>

# For Gemini CLI:
GEMINI_OAUTH_CLIENT_ID=<google-oauth-client-id>
GEMINI_OAUTH_CLIENT_SECRET=<google-oauth-client-secret>
GEMINI_CLI_OAUTH_CLIENT_SECRET=<google-oauth-client-secret>
```

**6. Restart Galyarder Route**
...
# Docker:
docker restart galyarder-route
```
...
1. Galyarder Route opens the Google authorization URL
...
4. Paste that URL into the field shown in the Galyarder Route connection modal
5. Click **"Connect"**
...
As credenciais OAuth embutidas no Galyarder Route estão cadastradas **apenas para `localhost`**. Quando você acessa o Galyarder Route em um servidor remoto (ex: `https://galyarder-route.meuservidor.com`), o Google rejeita a autenticação com:
...
- Nome: escolha qualquer nome (ex: `Galyarder Route Remote`)
...
1. O Galyarder Route abrirá a URL de autorização do Google
2. Após você autorizar, o Google tentará redirecionar para `localhost` (que falha no servidor remoto)
3. **Copie a URL completa** da barra de endereço do seu browser (mesmo que a página não carregue)
4. Cole essa URL no campo que aparece no modal de conexão do Galyarder Route
5. Clique em **"Connect"**
...
- **Website**: [galyarder-route.online](https://galyarder-route.online)
- **Package**: [npmjs.com/package/galyarder-route](https://www.npmjs.com/package/galyarder-route)
- **Docker**: [hub.docker.com/r/galyarderlabs/galyarder-route](https://hub.docker.com/r/galyarderlabs/galyarder-route)
...
Galyarder Route has **218+ features planned** across multiple development phases. Here are the key areas:
...
[![Contributors](https://contrib.rocks/image?repo=galyarderlabs/galyarder-route&max=100&columns=20&anon=1)](https://github.com/galyarderlabs/galyarder-route/graphs/contributors)
...
<a href="https://www.star-history.com/?repos=galyarderlabs%2Fgalyarder-route&type=date&legend=top-left">
 <picture>
   <source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/chart?repos=galyarderlabs/galyarder-route&type=date&theme=dark&legend=top-left" />
   <source media="(prefers-color-scheme: light)" srcset="https://api.star-history.com/chart?repos=galyarderlabs/galyarder-route&type=date&legend=top-left" />
   <img alt="Star History Chart" src="https://api.star-history.com/chart?repos=galyarderlabs/galyarder-route&type=date&legend=top-left" />
 </picture>
</a>

## 🌍 StarMapper

<a href="https://starmapper.bruniaux.com/galyarderlabs/galyarder-route">
  <picture>
    <source media="(prefers-color-scheme: dark)" srcset="https://starmapper.bruniaux.com/api/map-image/galyarderlabs/galyarder-route?theme=dark" />
    <source media="(prefers-color-scheme: light)" srcset="https://starmapper.bruniaux.com/api/map-image/galyarderlabs/galyarder-route?theme=light" />
    <img alt="StarMapper" src="https://starmapper.bruniaux.com/api/map-image/galyarderlabs/galyarder-route" />
  </picture>
</a>

## 🙏 Acknowledgments

Special thanks to **[9router](https://github.com/decolua/9router)** by **[decolua](https://github.com/decolua)** — the original project that inspired this fork. Galyarder Route builds upon that incredible foundation with additional features, multi-modal APIs, and a full TypeScript rewrite.
...
<div align="center">
  ...
  <br/>
  <sub><a href="https://galyarder-route.online">galyarder-route.online</a></sub>
</div>
