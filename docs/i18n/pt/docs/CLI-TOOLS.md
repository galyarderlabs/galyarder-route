# CLI Tools Setup Guide — Galyarder Route (Português (Portugal))
...
export ANTHROPIC_API_KEY="sk-your-galyarder-route-key"
...
cat > ~/.claude/settings.json   <<< "{\"apiBaseUrl\":\"$GALYARDER_ROUTE_URL\",\"apiKey\":\"$GALYARDER_ROUTE_KEY\"}"
...
export ANTHROPIC_BASE_URL="$GALYARDER_ROUTE_URL"
export ANTHROPIC_API_KEY="$GALYARDER_ROUTE_KEY"
EOF
