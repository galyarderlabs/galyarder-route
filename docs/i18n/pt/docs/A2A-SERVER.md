# Galyarder Route A2A Server Documentation (Português (Portugal))
...
> Agent-to-Agent Protocol v0.3 — Galyarder Route as an intelligent routing agent
...
Returns the Agent Card describing Galyarder Route's capabilities, skills, and authentication requirements.
...
| Skill              | Description                                                                                                                     |
| :----------------- | :------------------------------------------------------------------------------------------------------------------------------ |
| `smart-routing`    | Routes prompts through Galyarder Route's intelligent pipeline. Returns response with routing explanation, cost, and resilience trace. |
