...
LABEL org.opencontainers.image.title="galyarder-route" \
  org.opencontainers.image.description="Unified AI proxy — route any LLM through one endpoint" \
  org.opencontainers.image.url="https://galyarder-route.online" \
  org.opencontainers.image.source="https://github.com/galyarderlabs/galyarder-route" \
...
ENV GALYARDER_ROUTE_MIGRATIONS_DIR=/app/migrations
