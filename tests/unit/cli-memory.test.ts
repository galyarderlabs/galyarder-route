/**
 * Tests for CLI Memory Sanitization (bin/galyarder-route.mjs)
 *
 * Tests cover:
...
describe("CLI Memory Limit Sanitization", () => {
  /**
   * Replicate the memory sanitization logic from bin/galyarder-route.mjs
   */
...
describe("CLI .env File Loading", () => {
  /**
   * Simulate the .env parsing logic from bin/galyarder-route.mjs
   */
