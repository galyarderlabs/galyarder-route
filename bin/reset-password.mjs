 ...
 *   npx galyarder-route reset-password
 *
 * Resets the admin password for GalyarderRoute.
...
console.log("\n🔑 GalyarderRoute — Password Reset\n");

async function main() {
  // Check if database exists
  if (!existsSync(DB_PATH)) {
    console.error(`❌ Database not found at: ${DB_PATH}`);
    console.error(`   Make sure GalyarderRoute has been started at least once.`);
  ...
  console.log("   Restart GalyarderRoute for changes to take effect.\n");
}
