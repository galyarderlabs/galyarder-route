 ...
 *
 * Serves the GalyarderRoute A2A Agent Card for discovery by other agents.
 ...
 *
 * Returns the GalyarderRoute Agent Card that describes this gateway's
 * capabilities as an A2A agent.
 */
export async function GET() {
  const agentCard = {
    name: "GalyarderRoute AI Gateway",
    description:
