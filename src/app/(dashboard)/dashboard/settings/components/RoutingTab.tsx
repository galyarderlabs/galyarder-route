        ...
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            ...
            <p className="text-sm text-text-muted">
              Control whether GalyarderRoute reuses only stored Gemini thought signatures or accepts
          ...
          {[
            {
              value: "enabled",
              label: "Enabled",
              desc: "Current behavior. Ignore client-provided signatures and keep using the stored GalyarderRoute flow.",
            },
            {
              value: "bypass",
              label: "Bypass",
      ...
      <Card>
        <div className="flex items-center gap-3 mb-4">
          ...
          <div>
            ...
            <p className="text-sm text-text-muted">
              Configure whether GalyarderRoute preserves client-provided cache_control markers
            </p>
          </div>
        </div>
          ...
          {[
            {
              ...
              desc: "For deterministic Claude-compatible flows, preserve client-provided cache_control as-is. If the request has no cache_control, GalyarderRoute does not inject any bridge-owned markers for CC-compatible third-party proxy compatibility.",
            },
            {
              value: "always",
            ...
            },
            {
              ...
              desc: "Always remove client cache_control headers and let GalyarderRoute manage caching where native provider flows support it.",
            },
          ].map((option) => (
            <button
              key={option.value}
