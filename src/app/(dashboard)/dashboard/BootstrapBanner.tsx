...
/**
 * Shown when GalyarderRoute was started with auto-generated secrets (zero-config mode).
...
export default function BootstrapBanner() {
  ...
  const dataDir =
    typeof navigator !== "undefined" && navigator.platform?.startsWith("Win")
      ? "%APPDATA%\\galyarder-route\\server.env"
      : "~/.galyarder-route/server.env";
    ...
    >
      ...
      <div className="flex-1 min-w-0">
        ...
        <p className="mt-0.5 text-amber-200/80">
          GalyarderRoute auto-generated secure encryption keys on first launch. They are persisted to{" "}
