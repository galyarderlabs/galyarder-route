      ...
      if (data?.needsLogin && data?.authUrl) {
        ...
        setTailscaleNotice({
          ...
          message: translateOrFallback(
            ...
            "Complete the Tailscale login in the opened browser tab. GalyarderRoute will retry automatically."
          ),
        });
      ...
      if (data?.funnelNotEnabled && data?.enableUrl) {
        ...
        setTailscaleNotice({
          ...
          message: translateOrFallback(
            ...
            "Enable Funnel for this device in the opened browser tab. GalyarderRoute will keep polling."
          ),
        });
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="rounded-xl border border-border p-4 bg-bg-subtle">
                ...
                <div className="mt-3 rounded-lg bg-bg p-3 border border-border/70">
                  ...
                  <code className="text-xs font-mono break-all">galyarder-route --mcp</code>
                </div>
                <div className="mt-3">
                  <Link
                    href="/dashboard/mcp"
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
              <div className="rounded-xl border border-border p-4 bg-bg-subtle">
                ...
                <ol className="text-sm text-text-muted space-y-1 list-decimal list-inside">
                  <li>{t("mcpQuickStartStep1") || "Run the MCP server via `galyarder-route --mcp`."}</li>
                  <li>
                  ...
                  <li>
                    {t("mcpQuickStartStep3") ||
                      "Invoke tools such as `galyarder_route_get_health` and `galyarder_route_list_combos`."}
                  </li>
                </ol>
              </div>
              <div className="rounded-xl border border-border p-4 bg-bg-subtle">
          ...
          <div className="rounded-lg border border-blue-500/30 bg-blue-500/10 p-4">
            <p className="text-sm font-medium text-blue-300">
              {translateOrFallback(
                ...
                "Installs Tailscale on this machine and prepares GalyarderRoute to enable Funnel."
              )}
            </p>
