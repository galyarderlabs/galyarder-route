...
import GalyarderRouteLogo from "@/shared/components/GalyarderRouteLogo";
      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 mb-16">
          ...
          <div className="col-span-2 lg:col-span-2">
            <div className="flex items-center gap-3 mb-6">
              <div className="size-6 rounded bg-[#E54D5E] flex items-center justify-center text-white">
                <GalyarderRouteLogo size={16} className="text-white" />
              </div>
          ...
          <div className="flex flex-col gap-4">
            ...
            <a
              className="text-gray-400 hover:text-[#E54D5E] text-sm transition-colors"
              href="https://www.npmjs.com/package/galyarder-route"
              target="_blank"
              rel="noopener noreferrer"
            >
              {t("npm")}
