...
export const DOCS_DEPLOYMENT_GUIDES = [
  {
    ...
    href: "https://github.com/galyarderlabs/galyarder-route/blob/main/docs/TERMUX_GUIDE.md",
  },
] as const;
...
export const DOCS_MCP_TOOL_GROUPS = [
  ...
  },
  {
    ...
    tools: ["galyarder_route_cache_stats", "galyarder_route_cache_flush"],
  },
  {
    titleKey: "mcpToolsMemoryTitle",
    textKey: "mcpToolsMemoryDesc",
    tools: ["galyarder_route_memory_search", "galyarder_route_memory_add", "galyarder_route_memory_clear"],
  },
  {
    titleKey: "mcpToolsSkillsTitle",
    textKey: "mcpToolsSkillsDesc",
    tools: [
      "galyarder_route_skills_list",
      "galyarder_route_skills_enable",
      "galyarder_route_skills_execute",
      "galyarder_route_skills_executions",
    ],
  },
] as const;
