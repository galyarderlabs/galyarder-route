...
export const autoNavSections: AutoGenNavSection[] = [
  {
    ...
    "items": [
      {
        "slug": "architecture",
        "title": "GalyarderRoute Architecture",
  ...
  },
  {
    ...
    "items": [
      {
        "slug": "auto-combo",
        "title": "GalyarderRoute Auto-Combo Engine",
      ...
      {
        "slug": "features",
        "title": "GalyarderRoute — Dashboard Features Gallery",
  ...
  },
  {
    ...
    "items": [
      {
        "slug": "a2a-server",
        "title": "GalyarderRoute A2A Server Documentation",
      ...
      {
        "slug": "mcp-server",
        "title": "GalyarderRoute MCP Server Documentation",
  ...
  },
  {
    ...
    "items": [
      ...
      },
      {
        ...
        "title": "GalyarderRoute Fly.io 部署指南",
      ...
      },
      {
        ...
        "title": "GalyarderRoute — Deployment Guide on VM with Cloudflare",
  ...
  },
  {
    ...
    "items": [
      ...
      {
        "slug": "proxy-guide",
        "title": "GalyarderRoute Proxy Guide",
    ...
    "items": [
      {
        ...
        "title": "galyarder-route — Codebase Documentation",
      ...
      {
        "slug": "uninstall",
        "title": "GalyarderRoute — Uninstall Guide",
...
export const autoSearchIndex: AutoGenSearchItem[] = [
  ...
  },
  {
    ...
    "fileName": "SETUP_GUIDE.md",
    "section": "Getting Started",
    "content": "Complete setup reference for GalyarderRoute. For the quick version, see the Quick Start in README. - Install Methods - CLI Tool Configuration - Protocol Setup (MCP + A2A) - Timeout Configuration - Split-Port Mode - Void Linux (xbps-src) - Uninstalling -------------------- --------------------------------",
    "headings": [
      "Table of Contents",
      "Install Methods",
      "npm (recommended)",
  ...
  },
  {
    ...
    "fileName": "COMPRESSION_ENGINES.md",
    "section": "Features",
    "content": "GalyarderRoute compression is built around engine contracts. A mode can run one engine directly (caveman or rtk) or a deterministic stacked pipeline that executes multiple engines in order. Mode Engine path Intended input ------------ ---------------------------------- -----------------------------------",
    "headings": [
      "Modes",
      "Engine Registry",
      "Caveman",
  ...
  },
  {
    ...
    "fileName": "COMPRESSION_GUIDE.md",
    "section": "Features",
    "content": "Save 15-95% on eligible context automatically. For a quick overview, see the README Compression section. GalyarderRoute implements a modular prompt compression pipeline that runs proactively before requests hit upstream providers. This means your token savings happen transparently — no changes needed to ",
    "headings": [
      "Overview",
      "Compression Modes",
      "Off",
  ...
  },
  {
    ...
    "fileName": "FREE_TIERS.md",
    "section": "Features",
    "content": "The ultimate aggregated reference for all permanently free LLM API providers. Consolidated from 6 community repositories. Use with GalyarderRoute to route through 25+ free providers simultaneously. Last consolidated: May 2026 · Sources: awesome-free-llm-apis, awesome-free-llm-apis2, free-llm-api-resource",
    "headings": [
      "Table of Contents",
      "Quick Comparison",
  ...
  },
  {
    ...
    "fileName": "RTK_COMPRESSION.md",
    "section": "Features",
    "content": "RTK compression is GalyarderRoute's command-aware compression engine for terminal and tool output. It is designed for coding-agent sessions where most context growth comes from test logs, build output, package manager noise, shell transcripts, Docker output, git output, and stack traces. RTK can run dire",
    "headings": [
      "What It Compresses",
      "Filter Resolution",
      "Filter DSL",
  ...
  },
  {
    ...
    "content": "Agent-to-Agent Protocol v0.3 — GalyarderRoute as an intelligent routing agent Returns the Agent Card describing GalyarderRoute's capabilities, skills, and authentication requirements. Sends a message to a skill and waits for the complete response. Response: Same as message/send but returns Server-Sent Events ",
    "headings": [
      "Agent Discovery",
      "Authentication",
      "Enablement",
  ...
  },
  {
    ...
    "fileName": "MCP-SERVER.md",
    "section": "API & Protocols",
    "content": "Model Context Protocol server with 37 tools across routing, cache, compression, memory, skills, and proxy operations GalyarderRoute MCP is built-in. Start it with: Or via the open-sse transport: See MCP Client Configuration for Claude Desktop, Cursor, Cline, and compatible MCP client setup. -------------",
    "headings": [
      "Installation",
      "IDE Configuration",
      "Essential Tools (8)",
  ...
  },
  {
    ...
    "fileName": "FLY_IO_DEPLOYMENT_GUIDE.md",
    "section": "Deployment",
    "content": "本文档记录 GalyarderRoute 在 Fly.io 上的实际部署方法，适用于两类场景： - 首次把当前项目部署到 Fly.io - 后续代码更新后继续发布 - 新项目参考同样流程部署 本文基于当前项目已经验证通过的配置整理，应用名为 galyarder-route。 当前仓库中的 fly.toml 已确认包含以下关键项： 说明： - app = 'galyarder-route' 决定实际部署到哪个 Fly 应用 - destination = '/data' 决定持久卷挂载目录 - 本项目必须让 DATADIR=/data，否则数据库和密钥会写到容器临时目录 --- Windows PowerShell： 如果安装脚",
    "headings": [
      "1. 部署目标",
      "2. 当前项目关键配置",
      "3. 必备工具",
  ...
  },
  {
    ...
    "fileName": "ENVIRONMENT.md",
    "section": "Operations",
    "content": "Complete reference for every environment variable recognized by GalyarderRoute. For a quick-start template, see .env.example. These must be set before the first run. Without them, the application will either refuse to start or operate with insecure defaults. Variable Required Default Source File Descript",
    "headings": [
      "Table of Contents",
      "1. Required Secrets",
      "Generation Commands",
  ...
  },
  {
    ...
    "fileName": "PROXY_GUIDE.md",
    "section": "Operations",
    "content": "Bypass geographic blocks, protect your identity, and route AI traffic through any proxy — with zero configuration complexity. GalyarderRoute includes a full-featured proxy management system that lets you route upstream AI provider traffic through HTTP, HTTPS, or SOCKS5 proxies. Whether you're in a blocke",
    "headings": [
      "Table of Contents",
      "Why Use Proxies?",
  ...
  },
  {
    ...
    "fileName": "RESILIENCE_GUIDE.md",
    "section": "Operations",
    "content": "How GalyarderRoute keeps your AI coding workflow running when providers fail. GalyarderRoute implements a multi-layered resilience system that ensures zero downtime: ------------ ------- ------------------------------------ Queue Size 10 Max queued requests per connection Pacing Interval 0ms Minimum gap betwe",
    "headings": [
      "Overview",
  ...
  },
  {
    ...
    "fileName": "I18N.md",
    "section": "Development",
    "content": "GalyarderRoute supports 30 languages with full dashboard UI translation, translated documentation, and RTL support for Arabic and Hebrew. 🌐 Languages: 🇺🇸 English 🇧🇷 Português (Brasil) 🇪🇸 Español 🇫🇷 Français 🇩🇪 Deutsch 🇮🇹 Italiano 🇷🇺 Русский 🇨🇳 中文 (简体) 🇯🇵 日本語 🇰🇷 한국어 🇸🇦 العربية 🇮🇳 ",
    "headings": [
      "Quick Reference",
      "Architecture",
      "Source of Truth",
  ...
  },
  {
    ...
    "fileName": "RELEASE_CHECKLIST.md",
    "section": "Development",
    "content": "Use this checklist before tagging or publishing a new GalyarderRoute release. 1. Bump package.json version (x.y.z) in the release branch. 2. Move release notes from [Unreleased] in CHANGELOG.md to a dated section: - [x.y.z] — YYYY-MM-DD 3. Keep [Unreleased] as the first changelog section for upcoming wor",
    "headings": [
  ...
  },
  {
    ...
    "fileName": "RFC-AUTO-ASSESSMENT.md",
    "section": "Other",
    "content": "GalyarderRoute's combo system currently requires manual configuration: users must know which providers and models are actually working, then manually wire them into combo chains. When providers fail (rate limits, auth errors, model deprecation), combos silently degrade — routing to dead endpoints that ti",
    "headings": [
      "Summary",
      "Problem Statement",
