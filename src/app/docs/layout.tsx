...
export const metadata = {
  title: {
    template: "%s — GalyarderRoute Docs",
    default: "GalyarderRoute Documentation",
  },
  description:
    "Comprehensive documentation for GalyarderRoute AI gateway — setup, API, compression, deployment, and more.",
  robots: {
    index: true,
    follow: true,
  },
