...
export const metadata: Metadata = {
  title: "GalyarderRoute Documentation",
  description:
    "Everything you need to route, compress, and scale your AI — setup guides, API reference, compression, deployment, and more.",
  openGraph: {
    title: "GalyarderRoute Documentation",
    description:
      "Comprehensive docs for GalyarderRoute AI gateway — setup, API, compression, deployment, and more.",
    type: "website",
    url: "https://galyarder-route.online/docs",
  },
  twitter: {
    card: "summary_large_image",
    title: "GalyarderRoute Documentation",
    description: "Comprehensive docs for GalyarderRoute AI gateway",
  },
};
...
const featuredLinks = [
  {
    ...
    title: "Setup Guide",
    icon: "rocket_launch",
    desc: "Get GalyarderRoute running in 3 minutes",
  },
  {
    slug: "api-reference",
    title: "API Reference",
  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="text-center mb-12">
        <h1 className="text-4xl font-bold text-text-main mb-4">GalyarderRoute Documentation</h1>
