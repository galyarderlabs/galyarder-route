...
export async function generateMetadata({
  ...
  return {
    title: `${docItem.item.title} — GalyarderRoute Docs`,
    description: `GalyarderRoute documentation: ${docItem.item.title}`,
  };
}
    ...
    itemListElement: [
      {
        ...
        position: 1,
        name: "Docs",
        item: `https://galyarder-route.online/docs`,
      },
      {
        "@type": "ListItem",
        position: 2,
        name: sectionTitle,
        item: `https://galyarder-route.online/docs/${slug}`,
      },
      {
        "@type": "ListItem",
        position: 3,
