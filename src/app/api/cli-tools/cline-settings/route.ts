...
// Check if GalyarderRoute is configured as OpenAI-compatible provider
const hasGalyarderRouteConfig = (globalState: any) => {
  ...
  return (
    ...
    (baseUrl.includes("localhost") ||
      ...
      baseUrl.includes("galyarder-route"))
  );
};
...
export async function GET(request: Request) {
  ...
  try {
    ...
    return NextResponse.json({
      ...
      hasGalyarderRoute: hasGalyarderRouteConfig(globalState),
...
// POST - Configure Cline to use GalyarderRoute as OpenAI-compatible provider
export async function POST(request: Request) {
  ...
  try {
    ...
    secrets.openAiApiKey = apiKey || "sk_galyarder_route";
...
// DELETE - Remove GalyarderRoute OpenAI-compatible provider config
export async function DELETE(request: Request) {
  ...
  try {
    ...
    return NextResponse.json({
      success: true,
      message: "GalyarderRoute settings removed from Cline",
    });
  } catch (error) {
