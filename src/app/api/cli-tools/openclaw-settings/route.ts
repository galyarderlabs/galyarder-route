...
const hasGalyarderRouteConfig = (settings: any) => {
  ...
  return !!settings.models.providers["galyarder-route"];
};
...
// POST - Update GalyarderRoute settings (merge with existing settings)
export async function POST(request: Request) {
  ...
  try {
    ...
    settings.agents.defaults.model.primary = `galyarder-route/${model}`;

    // Update models.providers.galyarder-route
    settings.models.providers["galyarder-route"] = {
...
export async function DELETE(request: Request) {
  ...
  try {
    ...
    // Remove GalyarderRoute from models.providers
    if (settings.models && settings.models.providers) {
      delete settings.models.providers["galyarder-route"];
    ...
    // Reset agents.defaults.model.primary if it uses galyarder-route
    if (settings.agents?.defaults?.model?.primary?.startsWith("galyarder-route/")) {
