...
import { resolveNestedComboTargets } from "@galyarder-route/open-sse/services/combo.ts";
    ...
    try {
      res = await fetch(internalUrl, {
        ...
        headers: {
          ...
          // GalyarderRoute's semantic cache or other request reuse layers.
          "X-Galyarder-Route-No-Cache": "true",
          ...(target.connectionId ? { "X-Galyarder-Route-Connection": target.connectionId } : {}),
