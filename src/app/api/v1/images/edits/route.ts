import { handleImageEdit } from "@galyarder-route/open-sse/handlers/imageGeneration.ts";
import { getProviderCredentials, clearRecoveredProviderState } from "@/sse/services/auth";
import { parseImageModel, getImageProvider } from "@galyarder-route/open-sse/config/imageRegistry.ts";
import { errorResponse, unavailableResponse } from "@galyarder-route/open-sse/utils/error.ts";
 ...
 * if the uploaded image was originally generated through GalyarderRoute — we then
