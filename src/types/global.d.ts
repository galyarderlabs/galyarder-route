/**
 * Global Type Declarations for GalyarderRoute
 *
...
declare namespace NodeJS {
  interface ProcessEnv {
    ...
    GALYARDER_ROUTE_PUBLIC_BASE_URL?: string;
    GALYARDER_ROUTE_CGPT_WEB_IMAGE_TIMEOUT_MS?: string;
    GALYARDER_ROUTE_CGPT_WEB_IMAGE_CACHE_MAX_MB?: string;
    GALYARDER_ROUTE_BASE_URL?: string;
    GALYARDER_ROUTE_DISABLE_BACKGROUND_SERVICES?: string;
    GALYARDER_ROUTE_PORT?: string;
