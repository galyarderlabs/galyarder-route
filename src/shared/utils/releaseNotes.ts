...
export const NEWS_JSON_URL =
  "https://raw.githubusercontent.com/galyarderlabs/galyarder-route/main/news.json";
export const CHANGELOG_RAW_URL =
  "https://raw.githubusercontent.com/galyarderlabs/galyarder-route/main/CHANGELOG.md";
export const CHANGELOG_GITHUB_URL =
  "https://github.com/galyarderlabs/galyarder-route/blob/main/CHANGELOG.md";
