...
export default function OAuthModal({
  ...
  const startOAuthFlow = useCallback(async () => {
    ...
    try {
      ...
      // show an auth code instead of redirecting back to GalyarderRoute.
      ...
      //   where GalyarderRoute is hosted — Google only accepts pre-registered localhost URIs with
      ...
      if (provider === "codex" || provider === "openai") {
        ...
        // Behind reverse proxy: use actual origin (e.g., https://galyarder-route.example.com/callback)
                ...
                <div className="rounded-lg border border-amber-500/30 bg-amber-500/10 p-3 text-xs text-amber-200">
                  ...
                  <strong>
                    {t.rich("googleOAuthWarning", {
                      ...
                      a: (c) => (
                        <a
                          href="https://github.com/galyarderlabs/galyarder-route#oauth-on-a-remote-server"
                          target="_blank"
                          rel="noreferrer"
                          className="underline"
                        >
