...
export const OAUTH_PROVIDERS = {
  ...
  "gitlab-duo": {
    ...
    authHint:
      "OAuth application with ai_features + read_user scopes. Configure GITLAB_DUO_OAUTH_CLIENT_ID and optionally GITLAB_DUO_OAUTH_CLIENT_SECRET on this GalyarderRoute instance.",
  },
...
export const APIKEY_PROVIDERS = {
  ...
  "azure-ai": {
    ...
    apiHint:
      "Foundry uses the OpenAI v1 surface with deployment names as models. GalyarderRoute normalizes root resource URLs to the v1 chat and /models endpoints.",
    passthroughModels: true,
  },
  bedrock: {
    id: "bedrock",
    ...
    authHint:
      "Use your Amazon Bedrock API key in Authorization: Bearer <key>. GalyarderRoute defaults to the OpenAI-compatible bedrock-mantle endpoint in us-east-1; set a regional base URL if your account uses another region or the bedrock-runtime /openai/v1 path.",
    apiHint:
  ...
  oci: {
    ...
    apiHint:
      "OCI exposes OpenAI-compatible chat and responses endpoints. Project ID is optional in GalyarderRoute but may be required for Responses and agentic workflows.",
    passthroughModels: true,
  },
  sap: {
    id: "sap",
  ...
  modal: {
    ...
    apiHint:
      "Modal commonly serves user-hosted OpenAI-compatible apps on /v1. GalyarderRoute will probe /v1/models and route chat traffic to /v1/chat/completions.",
    hasFree: true,
  ...
  reka: {
    ...
    authHint:
      "Use your Reka API key. GalyarderRoute supports the OpenAI-compatible base URL https://api.reka.ai/v1 and sends both Authorization and X-Api-Key headers for compatibility.",
    apiHint:
      "Reka Chat is OpenAI-compatible on /v1. GalyarderRoute probes /v1/models and routes chat traffic to /v1/chat/completions.",
    hasFree: true,
  ...
  nlpcloud: {
    ...
    authHint:
      "Use your NLP Cloud API key in Authorization: Token <key>. GalyarderRoute targets the chatbot endpoint on https://api.nlpcloud.io/v1/gpu/<model>/chatbot by default.",
    apiHint:
      "NLP Cloud uses a proprietary chatbot API instead of OpenAI chat/completions. GalyarderRoute adapts OpenAI messages to input/context/history and exposes a local catalog of supported chatbot models.",
    hasFree: true,
  ...
  runwayml: {
    ...
    authHint:
      "Use your Runway API key in Authorization: Bearer <key>. GalyarderRoute targets the current Runway API at https://api.dev.runwayml.com/v1 and sends the required X-Runway-Version header automatically.",
    apiHint:
      "Runway video generation is task-based. GalyarderRoute submits text-to-video or image-to-video jobs, polls /v1/tasks/{id}, and normalizes the finished video outputs back into the OpenAI-like /v1/videos/generations response.",
  },
  anthropic: {
    id: "anthropic",
    alias: "anthropic",
  ...
  clarifai: {
    ...
    authHint:
      "Use your Clarifai PAT or app-specific API key. GalyarderRoute targets the OpenAI-compatible endpoint at https://api.clarifai.com/v2/ext/openai/v1 and authenticates with Authorization: Key <token>.",
    apiHint:
  ...
  "nous-research": {
    ...
    authHint:
      "Use your Nous Portal API key. GalyarderRoute targets the official OpenAI-compatible inference endpoint at https://inference-api.nousresearch.com/v1.",
    apiHint:
  ...
  petals: {
    ...
    apiHint:
      "Petals exposes a public HTTP API at https://chat.petals.dev/api/v1/generate and a WebSocket API at /api/v2/generate. GalyarderRoute targets the HTTP generate endpoint and supports self-hosted base URLs.",
  },
  poe: {
    id: "poe",
    alias: "poe",
