...
export const webRuntimeEnvSchema = z.object({
  ...
  GALYARDER_ROUTE_DISABLE_BACKGROUND_SERVICES: optionalBooleanEnv,
  CLOUD_URL: optionalHttpUrl,
  NEXT_PUBLIC_CLOUD_URL: optionalHttpUrl,
  GALYARDER_ROUTE_PUBLIC_BASE_URL: optionalHttpUrl,
  GALYARDER_ROUTE_BASE_URL: optionalHttpUrl,
  BASE_URL: optionalHttpUrl,
  NEXT_PUBLIC_BASE_URL: optionalHttpUrl,
  GALYARDER_ROUTE_PORT: optionalPortEnv,
