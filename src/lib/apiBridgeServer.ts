...
declare global {
  var __galyarderRouteApiBridgeStarted: boolean | undefined;
}

export function initApiBridgeServer(): void {
  if (globalThis.__galyarderRouteApiBridgeStarted) return;
  ...
  server.listen(apiPort, host, () => {
    globalThis.__galyarderRouteApiBridgeStarted = true;
