 ...
 * The PRIMARY key is now derived with a static salt ("galyarder-route-field-encryption-v1").
 ...
 * a different derived key than the static salt `"galyarder-route-field-encryption-v1"`. When the
...
const KEY_LENGTH = 32;
const PREFIX = "enc:v1:";
const STATIC_SALT = "galyarder-route-field-encryption-v1";
