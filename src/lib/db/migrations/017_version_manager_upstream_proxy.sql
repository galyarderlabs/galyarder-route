...
CREATE TABLE IF NOT EXISTS version_manager (
  ...
  tool              TEXT NOT NULL UNIQUE,           -- 'cliproxyapi' | 'galyarder-route'
  ...
  auto_start        INTEGER NOT NULL DEFAULT 0,    -- 1 = start with Galyarder Route
...
-- Determines whether each provider uses Galyarder Route's native executor,
