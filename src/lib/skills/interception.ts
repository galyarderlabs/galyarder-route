...
import { GALYARDER_ROUTE_WEB_SEARCH_FALLBACK_TOOL_NAME } from "@galyarder-route/open-sse/services/webSearchFallback.ts";
...
const BUILTIN_TOOL_ALIASES: Record<string, string> = {
  [GALYARDER_ROUTE_WEB_SEARCH_FALLBACK_TOOL_NAME]: "web_search",
};
