...
export const AUTHZ_HEADER_ROUTE_CLASS = "x-galyarder-route-route-class";

export const AUTHZ_HEADER_AUTH_KIND = "x-galyarder-route-auth-kind";
export const AUTHZ_HEADER_AUTH_ID = "x-galyarder-route-auth-id";
export const AUTHZ_HEADER_AUTH_LABEL = "x-galyarder-route-auth-label";
export const AUTHZ_HEADER_AUTH_SCOPES = "x-galyarder-route-auth-scopes";
