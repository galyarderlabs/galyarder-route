 ...
 *
 * Source of truth for which browser origins may call GalyarderRoute over CORS.
...
const STANDARD_ALLOW_HEADERS =
  "Content-Type, Authorization, x-api-key, anthropic-version, x-galyarder-route-connection, x-internal-test, accept";
