...
const nextConfig = {
  ...
  output: "standalone",
  // GalyarderRoute is a proxy for AI APIs — request bodies routinely include
  ...
  experimental: {
    serverActions: {
      bodySizeLimit: process.env.GALYARDER_ROUTE_SERVER_ACTIONS_BODY_LIMIT || "50mb",
    },
  },
  ...
  transpilePackages: ["@galyarder-route/open-sse", "@lobehub/icons"],
